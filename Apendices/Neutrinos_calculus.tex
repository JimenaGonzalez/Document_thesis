...
\begin{align}
  &\begin{aligned}
     ...
     \mathllap{-i \partial_\mu \psi_R^\dagger \gamma^{\mu \dagger}\gamma^0} &= m \psi_L^\dagger \gamma^0  &test{Multiplying on the right by $\gamma^0$}\\
  &\end{aligned}
\end{align}
...
and multiply it on the right by $\gamma^0$:
